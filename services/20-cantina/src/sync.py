"""SyncManager for Cantina — fetches and persists contest data."""
...
from src.client import CantinaClient
...
class SyncManager:
    """Manages sync of Cantina contest data from REST API to JSON files.
    ...
    async def run_sync(self) -> SyncStatus:
        ...
        try:
            ...
            for unified in contests:
                ...
                try:
                    async with CantinaClient() as detail_client:
