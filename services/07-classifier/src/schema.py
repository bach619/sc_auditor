...
CREATE INDEX IF NOT EXISTS idx_classifications_verdict_time ON classification_layers(classification, classified_at DESC);
CREATE INDEX IF NOT EXISTS idx_layers_stage ON classification_layers(stage);
"""
