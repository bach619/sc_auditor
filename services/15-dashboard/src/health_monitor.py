...
SERVICES: list[ServiceInfo] = [
    ...
    ServiceInfo("02-immunefi",      "http://02-immunefi:8000",     ["01-config"]),
    ServiceInfo("03-source",        "http://03-source:8000",       ["01-config"]),
    ServiceInfo("04-scanner",       "http://04-scanner:8000",      ["01-config"]),
    ServiceInfo("04a-scanner-slither", "http://04a-scanner-slither:8014", ["01-config"]),
    ServiceInfo("04b-scanner-echidna", "http://04b-scanner-echidna:8015", ["01-config"]),
    ServiceInfo("04c-scanner-forge", "http://04c-scanner-forge:8016",   ["01-config"]),
    ServiceInfo("04d-scanner-halmos", "http://04d-scanner-halmos:8017", ["01-config"]),
    ServiceInfo("05-scanner-mythril", "http://05-scanner-mythril:8013", ["01-config"]),
    ServiceInfo("06-ai",            "http://06-ai:8000",           ["01-config"]),
    ServiceInfo("07-classifier",    "http://07-classifier:8000",   ["06-ai", "01-config"]),
    ...
    ServiceInfo("10-notifier",      "http://10-notifier:8000",     ["09-reporter", "01-config"]),
    ...
    ServiceInfo("14-agent",         "http://14-agent:8000",        ["01-config"]),
