...
CREATE INDEX IF NOT EXISTS idx_audits_created_chain ON audits(created_at DESC, chain);
CREATE INDEX IF NOT EXISTS idx_audits_completed_state ON audits(completed_at, state);
CREATE INDEX IF NOT EXISTS idx_pipeline_step_name_state ON pipeline_steps(step_name, state);
